...
public class ChainLight extends Light {
    ...
    public void updateChain() {
        ...
        box2dLight.Spinor tmpAngle = Pools.obtain(box2dLight.Spinor.class);
        // Spinors used to represent perpendicular angle of each segment
        box2dLight.Spinor previousAngle = Pools.obtain(box2dLight.Spinor.class);
        box2dLight.Spinor currentAngle = Pools.obtain(box2dLight.Spinor.class);
        box2dLight.Spinor nextAngle = Pools.obtain(box2dLight.Spinor.class);
        // Spinors used to represent start, end and interpolated ray
        // angles for a given segment
        box2dLight.Spinor startAngle = Pools.obtain(box2dLight.Spinor.class);
        box2dLight.Spinor endAngle = Pools.obtain(box2dLight.Spinor.class);
        box2dLight.Spinor rayAngle = Pools.obtain(box2dLight.Spinor.class);
