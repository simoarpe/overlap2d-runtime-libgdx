...
public class PointLight extends PositionalLight {
     ...
     */
    public PointLight(box2dLight.RayHandler rayHandler, int rays) {
     ...
     */
    public PointLight(box2dLight.RayHandler rayHandler, int rays, Color color,
    ...
    public void setDistance(float dist) {
        dist *= box2dLight.RayHandler.gammaCorrectionParameter;
