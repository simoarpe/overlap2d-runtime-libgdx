...
import com.box2dLight.shader.DiffuseShader;
import com.box2dLight.shader.Gaussian;
import com.box2dLight.shader.ShadowShader;
import com.box2dLight.shader.WithoutShadowShader;
...
class LightMap {
    ...
    public LightMap(RayHandler rayHandler, int fboWidth, int fboHeight) {
        ...
        if (fboHeight <= 0)
            fboHeight = 1;
        frameBuffer = BasicFramebufferBuilder.createBasicExtended(Format.RGBA8888, fboWidth, fboHeight, false, false, false);
        pingPongBuffer = BasicFramebufferBuilder.createBasicExtended(Format.RGBA8888, fboWidth, fboHeight, false, false, false);
