...
public class ChainLight extends Light {
    ...
    public void updateChain() {
        ...
        com.box2dLight.Spinor tmpAngle = Pools.obtain(com.box2dLight.Spinor.class);
        // Spinors used to represent perpendicular angle of each segment
        com.box2dLight.Spinor previousAngle = Pools.obtain(com.box2dLight.Spinor.class);
        com.box2dLight.Spinor currentAngle = Pools.obtain(com.box2dLight.Spinor.class);
        com.box2dLight.Spinor nextAngle = Pools.obtain(com.box2dLight.Spinor.class);
        // Spinors used to represent start, end and interpolated ray
        // angles for a given segment
        com.box2dLight.Spinor startAngle = Pools.obtain(com.box2dLight.Spinor.class);
        com.box2dLight.Spinor endAngle = Pools.obtain(com.box2dLight.Spinor.class);
        com.box2dLight.Spinor rayAngle = Pools.obtain(com.box2dLight.Spinor.class);
