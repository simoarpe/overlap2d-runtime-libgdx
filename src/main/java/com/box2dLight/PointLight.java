...
public class PointLight extends PositionalLight {
     ...
     */
    public PointLight(com.box2dLight.RayHandler rayHandler, int rays) {
     ...
     */
    public PointLight(com.box2dLight.RayHandler rayHandler, int rays, Color color,
    ...
    public void setDistance(float dist) {
        dist *= com.box2dLight.RayHandler.gammaCorrectionParameter;
